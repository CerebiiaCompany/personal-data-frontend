...
import { fetchUsers, fetchCompanyUsers } from "@/lib/user.api";
...
export function useUsers<T = SessionUser[]>(params: QueryParams) {
  ...
  async function fetch() {
    setLoading(true);
    const fetchedData = await fetchUsers(params);
