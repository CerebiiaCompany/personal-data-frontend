...
export default function AdministrationPage() {
  ...
  const quickAccessCards = [
    ...
    {
      title: "Finalidades",
      description: "Administra el catálogo de finalidades de tratamiento (RAT) propio de tu empresa.",
      href: "/admin/administracion/finalidades",
  ...
  return (
    <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col bg-[#F8FAFC]">
      ...
      <div className="w-full px-5 pt-5 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
        <section
          data-tour="administracion-header"
          className={clsx(topCardClass, "px-5 py-5 sm:px-6 sm:py-6")}
        >
          <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-8">
            <div className="min-w-0 flex-1 space-y-2">
              <div className="flex items-start justify-between gap-3">
                ...
                <ModuleHelpButton tourId="administracion" />
              </div>
            ...
            <div
              data-tour="administracion-profile"
      ...
      <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col px-5 py-6 sm:px-6 sm:py-7 lg:px-8 lg:py-8 xl:px-10 2xl:px-12">
        <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col gap-6 md:gap-8">
          <section
            data-tour="administracion-company"
            className="rounded-2xl border border-[#E8EDF7] bg-white p-5 shadow-[0_2px_12px_rgba(15,35,70,0.04)] sm:p-6"
          >
          ...
          <section
            data-tour="administracion-cards"
            className="rounded-2xl border border-[#E8EDF7] bg-white p-5 shadow-[0_2px_12px_rgba(15,35,70,0.04)] sm:p-6"
          >
            <h2 className="mb-4 text-[16px] font-bold text-[#1A2B5B]">
              Accesos rápidos
